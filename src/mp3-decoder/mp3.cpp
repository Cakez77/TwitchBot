...
void mp3::set_tables()
{
	switch (sampling_rate) {
		...
		case 48000:
			...
			break;
		case 22050:
			band_index.short_win = band_index_table.long_22;
			band_width.short_win = band_width_table.long_22;
			band_index.long_win = band_index_table.long_22;
			band_width.long_win = band_width_table.long_22;
		break;
	}
}
